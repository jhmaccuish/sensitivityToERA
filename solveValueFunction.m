...
V        = NaN(T+1, numPointsA, m*numPointsY);
policyA1 = NaN(T,   numPointsA, m*numPointsY);
policyC  = NaN(T,   numPointsA, m*numPointsY);  
policyL  = NaN(T,   numPointsA, m*numPointsY);  
...
EV  = NaN(T+1, numPointsA, m*numPointsY);
EdU = NaN(T,   numPointsA, m*numPointsY);
...
%         end
        for ixA = 1:1:numPointsA                   % points on asset grid
            ...
            for ixY = 1:1:numPointsY               % points on income grid
                negV = inf;
    %             for ixU = 0:1%0=not unemployed, 1=unemployed
    %                 ixY = ixY + ixU*numPointsY;
